package com.specture.core.advice;

import com.specture.core.exception.*;
import com.specture.core.response.ErrorResponse;
...
public class ControllerErrorAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(ProbePortNotFoundException.class)
    public ErrorResponse handleNotFoundProbePortByNameAndUuid(ProbePortNotFoundException exception) {
        return new ErrorResponse(exception.getMessage());
    }

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(ProviderNotFoundException.class)
    public ErrorResponse handleNotFoundProviderById(ProviderNotFoundException exception) {
        return new ErrorResponse(exception.getMessage());
    }
