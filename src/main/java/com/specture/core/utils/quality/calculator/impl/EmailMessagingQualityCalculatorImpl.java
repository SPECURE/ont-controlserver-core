...
@Component
public class EmailMessagingQualityCalculatorImpl extends BaseQualityCalculator implements QualityCalculator {
    ...
    public UserExperienceQuality calculate(List<UserExperienceParameter> parameters) {
        ...
        emailMarks.add(getQuality(
                ...
                new ParameterCondition(MORE_OR_EQUAL, 500),
                new ParameterCondition(MORE_OR_EQUAL, 300),
                new ParameterCondition(MORE_OR_EQUAL, 100),
