...
public interface Config {
    ...
    //    List<MeasurementType> SERVER_HTTP_TEST_SERVER_TYPES = List.of(MeasurementType.RMBT, MeasurementType.RMBThttp);//TODO
//    List<MeasurementType> SERVER_WS_TEST_SERVER_TYPES = List.of(MeasurementType.RMBTws, MeasurementType.RMBThttp);
